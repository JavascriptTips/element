	...
	exports.default = {
	  ...
	  mounted: function mounted() {
	    ...
	    this.$nextTick(function () {
	      ...
	      var input = _this.$slots.default[0];
	      var $input;
	      ...
	      if (input) {
	        ...
	        var option = {
	          ...
	          timeFormat: _this.timePicker ? 'HH:mm:ss' : undefined,
	          onSelect: function onSelect(e) {

	            $input.datetimepicker('setDate', e);

	            _this.$emit('input', $input.val());
	          }
	        };
	        option = Object.assign(option, {
	          minDate: _this.minDate,
	          maxDate: _this.maxDate,
	          minDateTime: _this.minDateTime,
	          maxDateTime: _this.maxDateTime
	        });
